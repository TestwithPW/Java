...
public class String_functions {
	...
	public static void main(String[] args) {
		...
		// String is predefined class in java.lang 
				...
				String s3 = "";
				String s4= "Manas QA"; 
				String s5= " Java Selenium Automation ";
				...
				// System.out.println(s3.charAt(1));// out of range SystemIndexOutOfBound
				
				
				// indexof - retun type - int
				System.out.println(s.indexOf("a"));
				System.out.println(s.indexOf("q")); // case sensitive
				System.out.println(s.indexOf("Q")); // case sensitive
				...
				//trim removes the spaces at end points of the string (start-end) - return type String
				
				System.out.println(s5.trim());
				
				
				// replace - replaces old chars or string with new - return type - string 
				System.out.println(s5.replace(" ", "#"));
				System.out.println(s5.replace("e", "0"));
				System.out.println(s5.replace("Java", "c#").replace("Auto", "Moto"));
